...
func VerifyFee(
	...
	denom string,
	baseFee *big.Int,
	homestead, istanbul, islondon, isCheckTx bool,
) (sdk.Coins, error) {
	...
	intrinsicGas, err := core.IntrinsicGas(txData.GetData(), accessList, isContractCreation, homestead, istanbul, isCheckTx)
	if err != nil {
