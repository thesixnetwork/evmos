...
func (s *PrecompileTestSuite) TestGetVotes() {
	...
	for _, tc := range testCases {
		s.Run(tc.name, func() {
			...
			bz, err := s.executor.GetVotes(ctx, &method, contract.CallerAddress, tc.args)
...
func (s *PrecompileTestSuite) TestGetVote() {
	...
	for _, tc := range testCases {
		s.Run(tc.name, func() {
			...
			bz, err := s.executor.GetVote(ctx, &method, contract.CallerAddress, args)
...
func (s *PrecompileTestSuite) TestGetDeposit() {
	...
	for _, tc := range testCases {
		s.Run(tc.name, func() {
			...
			bz, err := s.executor.GetDeposit(ctx, &method, contract.CallerAddress, args)
...
func (s *PrecompileTestSuite) TestGetDeposits() {
	...
	for _, tc := range testCases {
		s.Run(tc.name, func() {
			...
			bz, err := s.executor.GetDeposits(ctx, &method, contract.CallerAddress, tc.args)
			if tc.expPass {
...
func (s *PrecompileTestSuite) TestGetTallyResult() {
	...
	for _, tc := range testCases {
		s.Run(tc.name, func() {
			...
			bz, err := s.executor.GetTallyResult(ctx, &method, contract.CallerAddress, args)
